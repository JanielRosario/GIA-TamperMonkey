...
$packageSlug = "agency-bookmark-installer"
$pagesBase = $PagesBaseUrl.TrimEnd("/")
$relativeDir = "Extentions/Staff-Bookmark-Installer"
...
$tempRoot = Join-Path ([IO.Path]::GetTempPath()) "agency-bookmark-installer-pack-$([guid]::NewGuid())"
$stagingDir = Join-Path $tempRoot "Staff-Bookmark-Installer"
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Agency Bookmark Installer</title>
  </head>
  <body>
    <h1>Agency Bookmark Installer</h1>
    <p>Version: $version</p>
